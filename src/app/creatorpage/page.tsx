        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 space-y-8">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-6">
            <div className="flex-shrink-0">
              <Image
                src="/images/my.png" // Path to your image in the public folder
                alt=""
                width={150}
                height={150}
            ...
            <div>
              ...
              <p className="mt-4 text-gray-600 leading-relaxed text-sm sm:text-base">
                Hi, I’m <span className="font-semibold">Sikandar Tahir</span>, an enthusiastic developer exploring the limitless
          ...
          <div className="bg-[#FEE5E5] sm:bg-[#EDEFFB] p-6 rounded-lg">
            ...
            <div className="mt-6 flex justify-center space-x-8 text-center text-2xl text-[#1D3178]">
              {/* Gmail */}
              <a
                href="mailto:sikandar.tahir.04@gmail.com"
